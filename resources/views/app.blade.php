...
<head>
    ...
    <style>
        ...
        .mCS-my-theme.mCSB_scrollTools .mCSB_dragger .mCSB_dragger_bar { height: 20px !important; bottom: 12px !important; }
...
<div class="container">
    <div class="row m-auto">
        <div class="col-12 col-md-1 d-md-block d-none" style="padding-top: 176px;   margin-right: 40px;">
            <script data-cfasync="false" type="text/javascript" src="https://www.dexpredict.com/a/display.php?r=4755587"></script>
        </div>
            ...
            <div class="row p-md-5 p-2" style="background: rgba(0, 0, 0, 0.18)">
                ...
                @else
                    <div class="text-center pt-2">
                        <script data-cfasync="false" type="text/javascript" src="https://www.dexpredict.com/a/display.php?r=4755583"></script>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-12 pt-md-0 pt-3" style="margin-left: auto;">
                            ...
                            <div class="text-center pt-md-3 pt-3">
                                <script data-cfasync="false" type="text/javascript" src="https://www.dexpredict.com/a/display.php?r=4755619"></script>
                            </div>
                        </div>
                    </div>
                    <div class="row p-4">
                ...
                <div class="row pt-2 text-center">
                    <div id="awn-z4755603"></div>
                </div>
            </div>
        </div>
        <div class="col-12 col-md-1 text-center" style="padding-top: 176px;">
            <script data-cfasync="false" type="text/javascript" src="https://www.dexpredict.com/a/display.php?r=4755591"></script>
        </div>
    </div>
</div>
<!-- Modal -->
...
<script data-cfasync="false" type="text/javascript">
    var zoneNativeSett={container:"awn",baseUrl:"discovernative.com/script/native.php",r:[4755603]};
